...
database_certificate = os.getenv('database_certificate', '/etc/beacon/certs/client.pem') # /etc/beacon/certs/client.pem
database_cafile = os.getenv('database_cafile', '/etc/beacon/certs/ca.crt') # /etc/beacon/certs/ca.crt
